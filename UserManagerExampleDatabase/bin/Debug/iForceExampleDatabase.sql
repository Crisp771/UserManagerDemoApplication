...
:setvar DefaultDataPath "F:\Users\Cris\AppData\Local\Microsoft\VisualStudio\SSDT\iForceExampleWebApplication"
:setvar DefaultLogPath "F:\Users\Cris\AppData\Local\Microsoft\VisualStudio\SSDT\iForceExampleWebApplication"
...
GO
ALTER TABLE [dbo].[Users] WITH CHECK CHECK CONSTRAINT [FK_Role];

ALTER TABLE [dbo].[Users] WITH CHECK CHECK CONSTRAINT [FK_Status];
